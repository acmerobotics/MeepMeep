...
public class RotateHeadingTool extends PathEditingTool {
    public RotateHeadingTool(RobotPath.PathType type, RoadRunnerBotEntity bot) {
        super(type, bot);
    }
    ...
    private void setNodeAngle(MouseEvent e) {
        ...
        path.setHeadingAngle(node, Math.atan2(mousePoint.getY()-node.y, mousePoint.getX()-node.x));
    }
